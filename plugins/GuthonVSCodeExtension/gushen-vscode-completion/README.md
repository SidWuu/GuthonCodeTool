...
- Decorates modified SVN files and their ancestor folders in the Guthon source tree, and highlights added, modified, and deleted locations against SVN BASE in the editor gutter, line background, and overview ruler.
