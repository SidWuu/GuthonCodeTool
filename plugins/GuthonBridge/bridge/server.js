...
const { ToolProcessClient } = require("../../GuthonNexus/gushen-vscode-completion/src/tool-process-client");
const fs = require("fs");
...
const BILL_TYPE_SCRIPT = process.env.GUTHON_BILL_TYPE_SCRIPT || path.join(ROOT, "scripts", "providers", "database", "export_bill_type_sql.py");
const VIEW_SQL_SCRIPT = process.env.GUTHON_VIEW_SQL_SCRIPT || path.join(ROOT, "scripts", "providers", "database", "export_view_sql.py");
const SYSTEM_SCRIPT_EXPORT_SCRIPT = process.env.GUTHON_SYSTEM_SCRIPT_EXPORT_SCRIPT || path.join(ROOT, "scripts", "providers", "database", "export_system_script_sql.py");
